...
export const ProductCardSkeleton = () => (
  <div className="bg-white/90 rounded-xl overflow-hidden shadow-md border border-gray-100">
...
export const ProductsGridSkeleton = ({ count = 6, className = "" }: { count?: number; className?: string }) => (
...
export const FeaturedProductsSectionSkeleton = () => (
  <section className="py-8 bg-gradient-to-br from-orange-500/50 to-indigo-900/50">
    <div className="container mx-auto px-4">
      <SectionHeaderSkeleton className="bg-white/20" />
...
// Loading Spinner (for small loading states)
